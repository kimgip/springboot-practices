...
/*
 * 1. 스프링 어플리케이션의 부트스트래핑 역할 : 모든 준비를 끝마침! : Bootstraping Class
...
public class HelloWorldApplication {
	...
	public static void main(String[] args) {
		 ...
		 * 1. 어플리케이션 커택스(Application Context, Spring Container) 생성
		 * 2. 만약, 웹애플리케이션이면 웹애플리케이션 타입 결정(SpringMVC, Reactive)
		 * 3. 어노테이션 스캐닝 + Configuration Class를 통해서 빈 생성/등록/와이어링(DI) 작업
